	 ...
	 <div class="banner-form" style="margin-top: 50px">
		 <div class="container">
			 <form action="AddServlet" method="post">
				<input type="text" value="" placeholder="book_ame" name="book_name"><br>
				<input type="text" value="" placeholder="author" name="author"><br>
				<input type="text" value="" placeholder="publishing" name="publishing"><br>
				<input type="text" value="" placeholder="num" name="num"><br>
